...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Для того чтобы войти в систему вы должны авторизироваться(используйте свой логин и пароль от личного кабинета студента Московского Политехнического Университета) /log_in",
